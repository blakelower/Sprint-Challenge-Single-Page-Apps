...
> Answer:
Client side routing has its benefits because it is manipulated by Javascript and makes it faster for the person using the site. The site wont take as long to reload and will quickly give the reults that are needed
